...
export default function About() {
  return (
    <div className="container">
      <Head>
        <title>Privacy Policy PlaylistTune.com</title>
      ...
      <main>
        ...
        <p>
          <strong>Last updated July 14, 2020</strong>
        </p>
        <p>
          Thank you for choosing to be part of our community at PlaylistTune.com
          (&ldquo;<strong>Company</strong>&rdquo;, &ldquo;<strong>we</strong>
          &rdquo;, &ldquo;<strong>us</strong>&rdquo;, or &ldquo;
          <strong>our</strong>&rdquo;). We are committed to protecting your
          ...
          info@kevinlambertmusic.com.
        </p>
        <p>
          When you visit our website{" "}
          <a href="https://playlisttune.com" target="_blank">
            https://playlisttune.com
          </a>{" "}
          (the "<strong>Website</strong>"), and more generally, use any of our
          services (the "<strong>Services</strong>", which include the Website),
        ...
        <p>
          ...
          <em>We collect information that you provide to us.</em>
        </p>
        <p>
        ...
        <ul type="disc">
          <li>
            ...
            proxy server), device application identification numbers, location,
        ...
        <ul type="disc">
          <li>
            ...
            disabling your Locations settings on your device. Note however, if
        ...
        <ul type="disc">
          <li>
            ...
            <strong> and manage your orders.</strong>&nbsp;We may use your
        ...
        <ul type="disc">
          <li>
            ...
            this is in accordance with your marketing preferences. For example,
        ...
        <ul type="disc">
          <li>
            ...
            information or otherwise interact with public areas of the Website,
            such personal information may be viewed by all users and may be
            publicly made available outside the Website in perpetuity.
        ...
        <p>
          ...
          consent to such minor dependent&rsquo;s use of the Website. If we
          ...
          please contact us at info@kevinlambertmusic.com.
        </p>
        <p>
        ...
        <p>
          PlaylistTune.com has not disclosed or sold any personal information to
          third parties for a business or commercial purpose in the preceding
          twelve (12) months. PlaylistTune.com will not sell personal
